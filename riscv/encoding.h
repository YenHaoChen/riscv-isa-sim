...
* https://github.com/riscv/riscv-opcodes (0ef5377)
*/
...
#define MIP_IMECCI          (1 << IRQ_IMECCI) // Andes::slave-port ECC error local interrupt
#define MIP_BWEI            (1 << IRQ_BWEI) // Andes::bus read/write transaction error local interrupt
#define MIP_PMOVI           (1 << IRQ_PMOVI) // Andes::performance monitor overflow local interrupt (replaced by LCOFI)
#define MIP_IMECCDMR        (1 << IRQ_IMECCDMR) // Andes::ECC MDR error local interrupt
#define MIP_ACEERR          (1 << IRQ_ACEERR) // Andes::ACE error local interrupt
...
#define IRQ_COP      12
#define IRQ_LCOF     13
#define IRQ_IMECCI   16 // Andes
#define IRQ_BWEI     17 // Andes
#define IRQ_PMOVI    18 // Andes (replaced by LCOFI)
#define IRQ_IMECCDMR 19 // Andes
#define IRQ_ACEERR   24 // Andes
...
#define MHSP_CTL_OVF_EN 0x00000001
#define MHSP_CTL_UDF_EN 0x00000002
#define MHSP_CTL_SCHM 0x00000004
#define MHSP_CTL_U 0x00000008
#define MHSP_CTL_S 0x00000010
#define MHSP_CTL_M 0x00000020

#define MMSC_CFG_ECC 0x00000001
#define MMSC_CFG_TLB_ECC 0x00000006
#define MMSC_CFG_ECD 0x00000008
#define MMSC_CFG_PFT 0x00000010
#define MMSC_CFG_HSP 0x00000020
#define MMSC_CFG_ACE 0x00000040
#define MMSC_CFG_ADDPMC 0x00000f80
#define MMSC_CFG_VPLIC 0x00001000
#define MMSC_CFG_EV5PE 0x00002000
#define MMSC_CFG_LMSLVP 0x00004000
#define MMSC_CFG_PMNDS 0x00008000
#define MMSC_CFG_CCTLCSR 0x00010000
#define MMSC_CFG_EFHW 0x00020000
#define MMSC_CFG_VCCTL 0x000c0000
#define MMSC_CFG_EXCSLVL 0x00300000
#define MMSC_CFG_NOPMC 0x00400000
#define MMSC_CFG_SPE_AFT 0x00800000
#define MMSC_CFG_ESLEEP 0x01000000
#define MMSC_CFG_PPI 0x02000000
#define MMSC_CFG_FIO 0x04000000
#define MMSC_CFG_CLIC 0x08000000
#define MMSC_CFG_ECLIC 0x10000000
#define MMSC_CFG_EDSP 0x20000000
#define MMSC_CFG_PPMA 0x40000000
    // 32bit only
#define MMSC_CFG_MSC_EXT 0x80000000
    // 64bit only
#define MMSC_CFG_BF16CVT 0x0000000100000000
#define MMSC_CFG_ZFH 0x0000000200000000
#define MMSC_CFG_VL4 0x0000000400000000
#define MMSC_CFG_CRASHSAVE 0x0000000800000000
#define MMSC_CFG_VECCFG 0x0000001000000000
#define MMSC_CFG_FINV 0x0000002000000000
#define MMSC_CFG_PP16 0x0000004000000000
#define MMSC_CFG_VSIH 0x0000010000000000
#define MMSC_CFG_ECDV 0x0000060000000000
#define MMSC_CFG_VDOT 0x0000080000000000
#define MMSC_CFG_VPFH 0x0000100000000000
#define MMSC_CFG_CCACHEMP_CFG 0x0000200000000000
#define MMSC_CFG_CCACHE  0x0000400000000000
#define MMSC_CFG_IO_COHP  0x0000800000000000
#define MMSC_CFG_CORE_PCLUS  0x000F000000000000
#define MMSC_CFG_RVARCH  0x0010000000000000
#define MMSC_CFG_TLB_RAM_CMD  0x0020000000000000
#define MMSC_CFG_CCTL_FL_UL  0x0040000000000000
#define MMSC_CFG_HSPO  0x0080000000000000

#define MMSC_CFG2_BF16CVT 0x00000001
#define MMSC_CFG2_ZFH 0x00000002
#define MMSC_CFG2_VL4 0x00000004
#define MMSC_CFG2_CRASHSAVE 0x00000008
#define MMSC_CFG2_VECCFG 0x00000010
#define MMSC_CFG2_FINV 0x00000020
#define MMSC_CFG2_PP16 0x00000040
#define MMSC_CFG2_VSIH 0x00000100
#define MMSC_CFG2_ECDV 0x00000600
#define MMSC_CFG2_VDOT 0x00000800
#define MMSC_CFG2_VPFH 0x00001000
#define MMSC_CFG2_CCACHEMP_CFG 0x00002000
#define MMSC_CFG2_CCACHE 0x00004000
#define MMSC_CFG2_IO_COHP  0x00008000
#define MMSC_CFG2_CORE_PCLUS  0x000F0000
#define MMSC_CFG2_RVARCH  0x00100000
#define MMSC_CFG2_TLB_RAM_CMD  0x00200000
#define MMSC_CFG2_CCTL_FL_UL  0x00400000
#define MMSC_CFG2_HSPO  0x00800000

#define MXSTATUS_PFT_EN 0x00000001
#define MXSTATUS_PPFT_EN 0x00000002
#define MXSTATUS_IME 0x00000004
#define MXSTATUS_PIME 0x00000008
#define MXSTATUS_DME 0x00000010
#define MXSTATUS_PDME 0x00000020
#define MXSTATUS_TYP 0x000000c0
#define MXSTATUS_PTYP 0x00000300

#define DEXC2DBG_IAM 0x00000001
#define DEXC2DBG_IAF 0x00000002
#define DEXC2DBG_II 0x00000004
#define DEXC2DBG_NMI 0x00000008
#define DEXC2DBG_LAM 0x00000010
#define DEXC2DBG_LAF 0x00000020
#define DEXC2DBG_SAM 0x00000040
#define DEXC2DBG_SAF 0x00000080
#define DEXC2DBG_UEC 0x00000100
#define DEXC2DBG_SEC 0x00000200
#define DEXC2DBG_HEC 0x00000400
#define DEXC2DBG_MEC 0x00000800
#define DEXC2DBG_HSP 0x00001000
#define DEXC2DBG_ACE 0x00002000
#define DEXC2DBG_SLPECC 0x00004000
#define DEXC2DBG_BWE 0x00008000
#define DEXC2DBG_IPF 0x00010000
#define DEXC2DBG_LPF 0x00020000
#define DEXC2DBG_SPF 0x00040000
#define DEXC2DBG_PMOV 0x00080000
...
#define PMA_TOR   0x01
#define PMA_NA4   0x02
#define PMA_NAPOT 0x03

#define PMACFG0_PMA0CFG 0x0000007f
#define PMACFG0_PMA0CFG_ETYP 0x00000003
#define PMACFG0_PMA0CFG_MTYP 0x0000003c
#define PMACFG0_PMA0CFG_NAMO 0x00000040
#define PMACFG0_PMA1CFG 0x00007f00
#define PMACFG0_PMA1CFG_ETYP 0x00000300
#define PMACFG0_PMA1CFG_MTYP 0x00003c00
#define PMACFG0_PMA1CFG_NAMO 0x00004000
#define PMACFG0_PMA2CFG 0x007f0000
#define PMACFG0_PMA2CFG_ETYP 0x00030000
#define PMACFG0_PMA2CFG_MTYP 0x003c0000
#define PMACFG0_PMA2CFG_NAMO 0x00400000
#define PMACFG0_PMA3CFG 0x7f000000
#define PMACFG0_PMA3CFG_ETYP 0x03000000
#define PMACFG0_PMA3CFG_MTYP 0x3c000000
#define PMACFG0_PMA3CFG_NAMO 0x40000000
    // 64bit only
#define PMACFG0_PMA4CFG 0x0000007f00000000
#define PMACFG0_PMA4CFG_ETYP 0x0000000300000000
#define PMACFG0_PMA4CFG_MTYP 0x0000003c00000000
#define PMACFG0_PMA4CFG_NAMO 0x0000004000000000
#define PMACFG0_PMA5CFG 0x00007f0000000000
#define PMACFG0_PMA5CFG_ETYP 0x0000030000000000
#define PMACFG0_PMA5CFG_MTYP 0x00003c0000000000
#define PMACFG0_PMA5CFG_NAMO 0x0000400000000000
#define PMACFG0_PMA6CFG 0x007f000000000000
#define PMACFG0_PMA6CFG_ETYP 0x0003000000000000
#define PMACFG0_PMA6CFG_MTYP 0x003c000000000000
#define PMACFG0_PMA6CFG_NAMO 0x0040000000000000
#define PMACFG0_PMA7CFG 0x7f00000000000000
#define PMACFG0_PMA7CFG_ETYP 0x0300000000000000
#define PMACFG0_PMA7CFG_MTYP 0x3c00000000000000
#define PMACFG0_PMA7CFG_NAMO 0x4000000000000000
    // 32bit only
#define PMACFG1_PMA4CFG 0x0000007f
#define PMACFG1_PMA4CFG_ETYP 0x00000003
#define PMACFG1_PMA4CFG_MTYP 0x0000003c
#define PMACFG1_PMA4CFG_NAMO 0x00000040
#define PMACFG1_PMA5CFG 0x00007f00
#define PMACFG1_PMA5CFG_ETYP 0x00000300
#define PMACFG1_PMA5CFG_MTYP 0x00003c00
#define PMACFG1_PMA5CFG_NAMO 0x00004000
#define PMACFG1_PMA6CFG 0x007f0000
#define PMACFG1_PMA6CFG_ETYP 0x00030000
#define PMACFG1_PMA6CFG_MTYP 0x003c0000
#define PMACFG1_PMA6CFG_NAMO 0x00400000
#define PMACFG1_PMA7CFG 0x7f000000
#define PMACFG1_PMA7CFG_ETYP 0x03000000
#define PMACFG1_PMA7CFG_MTYP 0x3c000000
#define PMACFG1_PMA7CFG_NAMO 0x40000000

#define PMACFG2_PMA8CFG 0x0000007f
#define PMACFG2_PMA8CFG_ETYP 0x00000003
#define PMACFG2_PMA8CFG_MTYP 0x0000003c
#define PMACFG2_PMA8CFG_NAMO 0x00000040
#define PMACFG2_PMA9CFG 0x00007f00
#define PMACFG2_PMA9CFG_ETYP 0x00000300
#define PMACFG2_PMA9CFG_MTYP 0x00003c00
#define PMACFG2_PMA9CFG_NAMO 0x00004000
#define PMACFG2_PMA10CFG 0x007f0000
#define PMACFG2_PMA10CFG_ETYP 0x00030000
#define PMACFG2_PMA10CFG_MTYP 0x003c0000
#define PMACFG2_PMA10CFG_NAMO 0x00400000
#define PMACFG2_PMA11CFG 0x7f000000
#define PMACFG2_PMA11CFG_ETYP 0x03000000
#define PMACFG2_PMA11CFG_MTYP 0x3c000000
#define PMACFG2_PMA11CFG_NAMO 0x40000000
    // 64bit only
#define PMACFG2_PMA12CFG 0x0000007f00000000
#define PMACFG2_PMA12CFG_ETYP 0x0000000300000000
#define PMACFG2_PMA12CFG_MTYP 0x0000003c00000000
#define PMACFG2_PMA12CFG_NAMO 0x0000004000000000
#define PMACFG2_PMA13CFG 0x00007f0000000000
#define PMACFG2_PMA13CFG_ETYP 0x0000030000000000
#define PMACFG2_PMA13CFG_MTYP 0x00003c0000000000
#define PMACFG2_PMA13CFG_NAMO 0x0000400000000000
#define PMACFG2_PMA14CFG 0x007f000000000000
#define PMACFG2_PMA14CFG_ETYP 0x0003000000000000
#define PMACFG2_PMA14CFG_MTYP 0x003c000000000000
#define PMACFG2_PMA14CFG_NAMO 0x0040000000000000
#define PMACFG2_PMA15CFG 0x7f00000000000000
#define PMACFG2_PMA15CFG_ETYP 0x0300000000000000
#define PMACFG2_PMA15CFG_MTYP 0x3c00000000000000
#define PMACFG2_PMA15CFG_NAMO 0x4000000000000000
    // 32bit only
#define PMACFG3_PMA12CFG 0x0000007f
#define PMACFG3_PMA12CFG_ETYP 0x00000003
#define PMACFG3_PMA12CFG_MTYP 0x0000003c
#define PMACFG3_PMA12CFG_NAMO 0x00000040
#define PMACFG3_PMA13CFG 0x00007f00
#define PMACFG3_PMA13CFG_ETYP 0x00000300
#define PMACFG3_PMA13CFG_MTYP 0x00003c00
#define PMACFG3_PMA13CFG_NAMO 0x00004000
#define PMACFG3_PMA14CFG 0x007f0000
#define PMACFG3_PMA14CFG_ETYP 0x00030000
#define PMACFG3_PMA14CFG_MTYP 0x003c0000
#define PMACFG3_PMA14CFG_NAMO 0x00400000
#define PMACFG3_PMA15CFG 0x7f000000
#define PMACFG3_PMA15CFG_ETYP 0x03000000
#define PMACFG3_PMA15CFG_MTYP 0x3c000000
#define PMACFG3_PMA15CFG_NAMO 0x40000000
...
#define MCACHE_CTL_IC_1ST_WD 0x00000800
#define MCACHE_CTL_DC_1ST_WD 0x00001000
#define MCACHE_CTL_DC_WARND  0x00006000
#define MCACHE_CTL_L2C_WARND 0x00018000
#define MCACHE_CTL_TLB_ECCEN 0x00060000
#define MCACHE_CTL_DC_COHEN  0x00080000
#define MCACHE_CTL_DC_COHSTA 0x00100000
#define MCACHE_CTL_DPREF_MODE 0x00600000
#define MCACHE_CTL_TLB_RWECC 0x00800000

#define FCSR_FFLAGS 0x1f
#define FCSR_FRM 0xe0

#define MICM_CFG_ISET 0x00000007
#define MICM_CFG_IWAY 0x00000038
#define MICM_CFG_ISZ 0x000001c0
#define MICM_CFG_ILCK 0x00000200
#define MICM_CFG_IC_ECC 0x00000c00
#define MICM_CFG_ILMB 0x00007000
#define MICM_CFG_ILMSZ 0x000f8000
#define MICM_CFG_ULM_2BANK 0x00100000
#define MICM_CFG_ILM_ECC 0x00600000
#define MICM_CFG_ILM_XONLY 0x00800000
#define MICM_CFG_SETH 0x01000000
#define MICM_CFG_IC_REPL 0x06000000

#define MDCM_CFG_DSET 0x00000007
#define MDCM_CFG_DWAY 0x00000038
#define MDCM_CFG_DSZ 0x000001c0
#define MDCM_CFG_DLCK 0x00000200
#define MDCM_CFG_DC_ECC 0x00000c00
#define MDCM_CFG_DLMB 0x00007000
#define MDCM_CFG_DLMSZ 0x000f8000
#define MDCM_CFG_ULM_2BANK 0x00100000
#define MDCM_CFG_DLM_ECC 0x00600000
#define MDCM_CFG_SETH 0x01000000
#define MDCM_CFG_DC_REPL 0x06000000

#define MMISC_CTL_ACE 0x00000001
#define MMISC_CTL_VEC_PLIC 0x00000002
#define MMISC_CTL_RVCOMPM 0x00000004
#define MMISC_CTL_BRPE 0x00000008
#define MMISC_CTL_ACES 0x00000030
#define MMISC_CTL_MSA 0x00000040
#define MMISC_CTL_NBLD_EN 0x00000100
#define MMISC_CTL_NEWNMI 0x00000200
#define MMISC_CTL_NBCACHE_EN 0x00000400
#define MMISC_CTL_LDX0NXP 0x00002000

#define COUNTER_CY 0x00000001
#define COUNTER_TM 0x00000002
#define COUNTER_IR 0x00000004
#define COUNTER_HPM3 0x00000008
#define COUNTER_HPM4 0x00000010
#define COUNTER_HPM5 0x00000020
#define COUNTER_HPM6 0x00000040
#define COUNTER_HPM7 0x00000080
#define COUNTER_HPM8 0x00000100
#define COUNTER_HPM9 0x00000200
#define COUNTER_HPM10 0x00000400
#define COUNTER_HPM11 0x00000800
#define COUNTER_HPM12 0x00001000
#define COUNTER_HPM13 0x00002000
#define COUNTER_HPM14 0x00004000
#define COUNTER_HPM15 0x00008000
#define COUNTER_HPM16 0x00010000
#define COUNTER_HPM17 0x00020000
#define COUNTER_HPM18 0x00040000
#define COUNTER_HPM19 0x00080000
#define COUNTER_HPM20 0x00100000
#define COUNTER_HPM21 0x00200000
#define COUNTER_HPM22 0x00400000
#define COUNTER_HPM23 0x00800000
#define COUNTER_HPM24 0x01000000
#define COUNTER_HPM25 0x02000000
#define COUNTER_HPM26 0x04000000
#define COUNTER_HPM27 0x08000000
#define COUNTER_HPM28 0x10000000
#define COUNTER_HPM29 0x20000000
#define COUNTER_HPM30 0x40000000
#define COUNTER_HPM31 0x80000000

#define UITB_HW 0x00000001
#define UITB_ADDR 0xfffffffc

#define MPFT_CTL_T_LEVEL 0x000000f0
#define MPFT_CTL_FAST_INT 0x00000100

#define MRVARCH_CFG_ZBA 0x00000001
#define MRVARCH_CFG_ZBB 0x00000002
#define MRVARCH_CFG_ZBC 0x00000004
#define MRVARCH_CFG_ZBS 0x00000008
#define MRVARCH_CFG_SMEPMP 0x00000010
#define MRVARCH_CFG_SVINVAL 0x00000020
#define MRVARCH_CFG_SMSTATEEN 0x00000040
#define MRVARCH_CFG_SSCOFMPF 0x00000080
#define MRVARCH_CFG_SSTC 0x00000100
#define MRVARCH_CFG_ZICBOM 0x00000200
#define MRVARCH_CFG_ZICBOP 0x00000400
#define MRVARCH_CFG_ZICBOZ 0x00000800
#define MRVARCH_CFG_ZBK 0x00001000
#define MRVARCH_CFG_ZKN 0x00002000
#define MRVARCH_CFG_ZKS 0x00004000
#define MRVARCH_CFG_ZKT 0x00008000
#define MRVARCH_CFG_ZKR 0x00010000
#define MRVARCH_CFG_SM_VERSION 0x000e0000
#define MRVARCH_CFG_SS_VERSION 0x00700000
#define MRVARCH_CFG_SVPBMT 0x00800000
#define MRVARCH_CFG_SVNAPOT 0x01000000
#define MRVARCH_CFG_ZIHINTPAUSE 0x02000000

#define DDCAUSE_MAINTYPE 0x000000ff
#define DDCAUSE_SUBTYPE 0x0000ff00

#define MDCAUSE_PM 0x60
#define SDCAUSE_PM 0x60
...
#define CAUSE_STACK_OVERFLOW 0x20
#define CAUSE_STACK_UNDERFLOW 0x21
...
#define INSN_FIELD_B14 0x4000
#define INSN_FIELD_B31 0x80000000
#define INSN_FIELD_B12_8 0x1f00
#define INSN_FIELD_B6_2 0x7c
#endif
#ifdef DECLARE_INSN
...
DECLARE_CAUSE("stack overflow", CAUSE_STACK_OVERFLOW)
DECLARE_CAUSE("stack underflow", CAUSE_STACK_UNDERFLOW)
#endif
